...
if(isset($_POST["btnokt"])){
    $order = <<<sqlcommond
    insert into orders (orderDate,customerId,customerName,productName,quantitys,price,total,unit)
    values (
        '{$_POST["o_date"]}', 
        '{$_POST["customerId"]}',
        '{$_POST["customername"]}',
...
<body>
    <div class="grid_container">
        ...
        <form  method="post" action="">
            <h3>新增訂單</h3>
            <input type="submit" name="btnokt" id="btnok" value="新增" />      
         ...
         <tr>
                ...
                <tr>
                   ...
                   <td><input class="insert" type="text" id="unit" name="unit" value="台斤"></td>
